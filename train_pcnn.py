...
if __name__ == '__main__':
    ...
    if args.meta_train:
        ...
        if cfg.mask_on:
            metadataset = ImagePatchDiorMetaDataset("/root/autodl-tmp/P-CNN-yuan/data/DIOR/",
                                                    img_set, metaclass, img_size, shots=shots, shuffle=True,
                                                    phase=args.phase)
        else:
            metadataset = DiorMetaDataset("/root/autodl-tmp/P-CNN-yuan/data/DIOR/",
    ...
    if args.resume:
        load_name = os.path.join(output_dir,
                                 '{}_Prototypecnn_{}_{}_{}.pth'.format(args.dataset, 200, #args.checksession, #得改成200才行
